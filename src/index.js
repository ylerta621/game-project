...
function findPad(color) {
  switch(color) {
    case "red": return pads[0];
    case "green": return pads[1];
    case "blue": return pads[2];
    case "yellow": return pads[3];
  }
}
...
function setLevel(level = 1) {
  ...
  switch(level) {
    ...
    case 3: return 20;
    case 4: return 31;
    case 5: "Please enter level 1, 2, 3, or 4";
    case 8: "Please enter level 1, 2, 3, or 4";
  }
}
...
function activatePads(sequence) {
  ...
  sequence.forEach((element) => {
    setTimeout(() => activatePad(element), 500);
  });
}
 ...
 */
 function playComputerTurn() {
  ...
  statusSpan.text = "The computer's turn..."
  let color = pads[1].color
